...
import type { Quest } from "@/components/admin/QuestModal";
import { BlurImage, EmptyState, ExpandableText, Section, Skeleton } from "@/components/ui";
    ...
    return (
        <Section id="side-quests" animate delay={0.1}>
            {!hasQuests ? (
                ...
                <div className="space-y-16 sm:space-y-24">
                    {quests.map((quest) => (
                        <div key={quest.id} className="flex flex-col lg:flex-row gap-6 lg:gap-10">
                            {/* Left: Meta Info */}
