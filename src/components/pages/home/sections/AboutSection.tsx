// Alternative hero/about layout. Not currently mounted by `home/index.tsx`.
import StacksCard from "@/components/pages/home/components/StacksCard";
    ...
    <div className="shadow-feature-card rounded-2xl p-4 flex flex-col gap-3 relative overflow-hidden">
        <div className="relative size-36 rounded-xl overflow-hidden">
            <div className="shadow-feature-card relative size-full overflow-hidden mb-8">
                {SITE_ASSETS.profileImage && (
                    <ImageZoom>
                        <BlurImage src={SITE_ASSETS.profileImage} alt="Profile Photo" />
                    </ImageZoom>
                )}
            </div>
        </div>
...
export const ImageCard: React.FC = () => (
    <div className="shadow-feature-card rounded-2xl overflow-hidden">
        {SITE_ASSETS.profileImage && (
            <Image src={SITE_ASSETS.profileImage} alt="Plane wing" width={500} height={500} className="w-full h-full object-cover" />
        )}
    </div>
);
