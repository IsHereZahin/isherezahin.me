    ...
    return (
        <div className={`${CARD} flex flex-1 flex-col`}>
            <div className="flex items-center gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#F6F4EF]">
                    <FileText className="h-5 w-5 text-[#57544e]" />
                </span>
                <div>
                    <h3 className="text-[16px] font-semibold text-[#26262B]">Top Pages</h3>
                    <p className="mt-0.5 text-[13px] text-[#9a978f]">Most visited routes</p>
                </div>
            </div>

            {pages.length === 0 ? (
                <p className="flex flex-1 items-center justify-center py-10 text-[13px] text-[#9a978f]">
                        ...
                        <div key={`${p.path}-${i}`} className="flex items-center gap-3">
                            ...
                            <div className="min-w-0 flex-1">
                                <div className="mb-1 flex items-center justify-between gap-3">
                                    <span className="truncate text-[13px] font-medium text-[#26262B]" title={p.path}>
                                        {prettyPath(p.path)}
                                    </span>
                                    <span className="shrink-0 text-[12px] tabular-nums text-[#9a978f]">{fmtFull(p.count)}</span>
                                </div>
